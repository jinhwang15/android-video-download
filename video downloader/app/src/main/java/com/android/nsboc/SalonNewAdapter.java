...
public class SalonNewAdapter extends ArrayAdapter<ParseObject> {

    public SalonNewAdapter(Context context) {
        super(context, 0);
    }
...
//        ((TextView) rootView.findViewById(R.id.phone)).setText(salon.getString("phone"));
        ...
        rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(activity, SalonNewDetailActivity.class);
