...
public class SalonDetailActivity extends AppCompatActivity {
    private String strIs_routine; //KKK
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        //KKK
        strIs_routine = getIntent().getStringExtra("is_routine");

        if(strIs_routine.equals("YES")) {
            setContentView(R.layout.activity_salon_detail_routine);
        }
        else {
            ...
            public void done(final ParseObject salon, ParseException e) {
                ...
                licenseView.setOnClickListener(new Button.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent =
                                new Intent(SalonDetailActivity.this, LicenseDetailActivity.class);
                ...
                contactsButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(SalonDetailActivity.this, StoreContactsEditActivity.class);
                        intent.putExtra("salon_id", salon.getObjectId());
                        startActivity(intent);
    ...
    public void removeLicensee(View view) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(SalonDetailActivity.this, "Coming soon", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    ...
    public void sanitationCompliance(View view) {
        ...
        if(strIs_routine.equals("YES")) {
            ...
            startActivity(new Intent(this, SalonCheckListActivity.class));//ComplianceStartActivity
        }
    }
    ...
    public void addLicensee(View view) {
        ...
        */
        ...
        builder.setPositiveButton("Add", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(SalonDetailActivity.this, "Database access needed", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
