...
public class SalonNewDetailActivity extends AppCompatActivity {
            ...
            public void done(final ParseObject salon, ParseException e) {
                ...
                licenseView.setOnClickListener(new Button.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent =
                                new Intent(SalonNewDetailActivity.this, LicenseDetailActivity.class);
                ...
                contactsButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(SalonNewDetailActivity.this, StoreContactsEditActivity.class);
                        intent.putExtra("salon_id", salon.getObjectId());
                        startActivity(intent);
    ...
    public void removeLicensee(View view) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(SalonNewDetailActivity.this, "Coming soon", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    ...
    public void addLicensee(View view) {
        ...
        */
        ...
        builder.setPositiveButton("Add", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(SalonNewDetailActivity.this, "Database access needed", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
